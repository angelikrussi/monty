 ...
 * Return: None.
 */
void op_mul(stack_t **stack, unsigned int n_line)
{
	int mul = 0;
 ...
 * Return: None.
 */
void op_mod(stack_t **stack, unsigned int n_line)
{
	int mod = 0;
 ...
 * Return: None.
 */
void op_pchar(stack_t **stack, unsigned int n_line)
{
 ...
 * Return: None.
 */
void op_pstr(stack_t **stack, unsigned int n_line)
{
	int i = 0;
	stack_t *copy = *stack;
 ...
 * Return: None.
 */
void op_rotl(stack_t **stack, unsigned int n_line)
{
	int temp, i = 0;
	stack_t *copy = *stack;
